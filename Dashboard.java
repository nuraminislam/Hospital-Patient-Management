...
public class Dashboard extends JFrame {
    ...
    public Dashboard(String username, BufferedImage logoImage, HospitalService hospitalService) {
        ...
        for (int i = 0; i < navItems.length; i++) {
            ...
            navItem.setMaximumSize(new Dimension(230, 44));
            ...
            navLabel.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        logoutPanel.setMaximumSize(new Dimension(230, 44));
        ...
        logoutLabel.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        logoutPanel.add(logoutLabel);
        logoutPanel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) { dispose(); new LoginPage(hospitalService); }
    ...
    private void showPage(String page) {
        ...
        switch (page) {
            ...
            case "Patients":     contentArea.add(buildSimplePage("🧑‍⚕️ Patients", "Manage patient records here.")); break;
